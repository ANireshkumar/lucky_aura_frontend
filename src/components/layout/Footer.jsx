...
const Footer = () => (
  <footer className="bg-gray-900 text-gray-300 py-12 mt-auto">
    <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-10">
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-display text-lg text-white">Luckyaura</span>
        </div>
        <p className="text-sm leading-relaxed text-gray-400">Premium organic skincare & haircare rooted in Ayurvedic tradition. Safe, effective, and nature-powered.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="space-y-2 text-sm text-gray-400">
          <p>📲 WhatsApp: 8870199716</p>
          <p>📧 hello@luckyaura.com</p>
          <a href="https://www.instagram.com/_luckyaura" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 mt-1 hover:text-emerald-400 transition-colors">
    ...
    <div className="border-t border-gray-800 mt-10 pt-6 text-center text-xs text-gray-500">
      © {new Date().getFullYear()} Luckyaura. All rights reserved.
    </div>
  </footer>
)
